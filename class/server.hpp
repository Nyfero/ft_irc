...
class server
{
    ...
    public:
        ...
        void    Pass_cmd(user *user, std::vector<std::string> cmd);
        void    Nick_cmd(user *user, std::vector<std::string> cmd);
        void    User_cmd(user *user, std::vector<std::string> cmd);
        //void    Oper_cmd(user *user, std::vector<std::string> cmd);
        void    Mode_cmd(user *user, std::vector<std::string> cmd);
        void    Join_cmd(user *user, std::vector<std::string> cmd);
        void    Part_cmd(user *user, std::vector<std::string> cmd);
        //void   Topic_cmd(user *user, std::vector<std::string> cmd);
        void    Quit_cmd(user *user, std::vector<std::string> cmd);
        
        void    Names_cmd(user *user, std::vector<std::string> cmd);
        void    Invite_cmd(user *user, std::vector<std::string> cmd);
        void    Kick_cmd(user *user, std::vector<std::string> cmd);
        void    Privmsg_cmd(user *user, std::vector<std::string> cmd);
        void    Notice_cmd(user *user, std::vector<std::string> cmd);
        void    Away_cmd(user *user, std::vector<std::string> cmd);
        void    Users_cmd(user *user, std::vector<std::string> cmd);
        void    Wallops_cmd(user *user, std::vector<std::string> cmd);
        void    Pong_cmd(user *user, std::vector<std::string> cmd);
};